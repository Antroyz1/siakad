          ...
          <ul class="sidebar-menu">
				<li class="header"><h4><b><center>Admin Nilai</center></b></h4></li>
					...
					<li><a  target=”_blank” href="nilai/index.php"><i class="fa fa-book"></i><span>Nilai Mahasiswa</span></a></li>
              		<li class="active"><a href="nilai.php"><i class="fa fa-book"></i><span>KRS</span></a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                	...
                	<a href="#"><button class="btn btn-success" type="button" data-target="#ModalCetak" data-toggle="modal"><i class="fa fa-search"></i> Cari </button></a>
