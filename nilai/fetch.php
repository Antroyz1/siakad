...
{
	$query .= '
	WHERE NIM_krs_Mhs LIKE "%'.$_POST["search"]["value"].'%" 
	OR Kode_Matakuliah_krs LIKE "%'.$_POST["search"]["value"].'%" 
	OR Semester_Ambil LIKE "%'.$_POST["search"]["value"].'%" 
	';
}
