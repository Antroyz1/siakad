    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a href="transkrip.php"><i class="fa fa-newspaper-o"></i><span>IP Semester</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-info-circle"></i> Cetak Transkrip</li>
          </ol>
        </section>
              ...
              <div class="box">
                ...
                <label class="control-label col-md-3">Kode Kelas</label>
                  ...
                  <label class="control-label col-md-3">NPM</label>
                    <input type="text"  placeholder="Nomor Pokok Mahasiswa" class="form-control" name="NIM" id="NIM" >					
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!-- /.col -->
          </div><!-- /.row -->
