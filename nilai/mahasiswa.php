...
<html>
 <head>
    <meta charset="utf-8">
    <title>MAHASISWA - AKBID Panca Bhakti Pontianak</title>
	<!-- Library CSS -->
	<?php
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
		...
		<!-- Modal Popup Mahasiswa Edit -->
		<div id="ModalEditMahasiswa" class="modal fade" tabindex="-1" role="dialog"></div>
		<!-- Modal Popup Transkrip Edit -->
		<div id="ModalEditTranskrip" class="modal fade" tabindex="-1" role="dialog"></div>
