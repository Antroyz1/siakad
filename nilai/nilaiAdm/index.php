 ...
 <body>
  <div class="container box">
   ...
   <div class="panel panel-default">
				<div class="panel-heading">Nilai Mahasiswa S1 Administrasi Kesehatan</div>
   ...
   <div class="row">
    ...
    <div class="col-md-4">
     ...
     <div class="form-group">
       ...
       <?php
			$querymatkul = mysqli_query($konek, "SELECT * FROM matakuliah WHERE Kode_Jurusan_Matkul = 'S1ADM' ORDER BY Semester_Matakuliah ASC");
  ...
  function fill_datatable(filter_kelas = '', filter_Kode = '')
  {
   var dataTable = $('#sample_data').DataTable({
    ...
    "ajax" : {
     ...
     type:"POST",
     data:{
      filter_kelas:filter_kelas, filter_Kode:filter_Kode
     }
    },
		createdRow:function(row, data, rowIndex)
		{
			$.each($('td', row), function(colIndex){
				if(colIndex == 1)
				{
					$(this).attr('data-name', 'NIM_krs_Mhs');
					$(this).attr('class', 'NIM_krs_Mhs');
					$(this).attr('data-type', 'text');
					$(this).attr('data-pk', data[0]);
				}
				if(colIndex == 2)
				{
					$(this).attr('data-name', 'Nama_Mahasiswa');
					$(this).attr('class', 'Nama_Mahasiswa');
					$(this).attr('data-type', 'text');
					$(this).attr('data-pk', data[0]);
				}
				if(colIndex == 3)
				{
					$(this).attr('data-name', 'Kode_Matakuliah_krs');
					$(this).attr('class', 'Kode_Matakuliah_krs');
					$(this).attr('data-type', 'text');
					$(this).attr('data-pk', data[0]);
				}
				if(colIndex == 4)
				{
					$(this).attr('data-name', 'Semester_Ambil');
					$(this).attr('class', 'Semester_Ambil');
					$(this).attr('data-type', 'text');
					$(this).attr('data-pk', data[0]);
				}
				if(colIndex == 5)
				{
					$(this).attr('data-name', 'Kehadiran');
					$(this).attr('class', 'Kehadiran');
					$(this).attr('data-type', 'text');
					$(this).attr('data-pk', data[0]);
				}
				if(colIndex == 6)
				{
					$(this).attr('data-name', 'Tugas');
					$(this).attr('class', 'Tugas');
					$(this).attr('data-type', 'text');
					$(this).attr('data-pk', data[0]);
				}
				if(colIndex == 7)
				{
					$(this).attr('data-name', 'UTS');
					$(this).attr('class', 'UTS');
					$(this).attr('data-type', 'text');
					$(this).attr('data-pk', data[0]);
				}
				...
				if(colIndex == 10)
				{
					$(this).attr('data-name', 'Nilai');
					$(this).attr('class', 'Nilai');
					$(this).attr('data-type', 'text');
					$(this).attr('data-pk', data[0]);
				}
				if(colIndex == 11)
				{
					$(this).attr('data-name', 'Mutu');
					$(this).attr('class', 'Mutu');
					$(this).attr('data-type', 'text');
					$(this).attr('data-pk', data[0]);
				}
			});
