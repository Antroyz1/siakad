    ...
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              <li class="header"><h4><b><center>ADMIN LAB.</center></b></h4></li>
	              ...
	              <li><a href="peminjam.php"><i class="fa fa-list-alt"></i><span>Peminjam</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-download"></i> Barang</li>
          </ol>
        </section>
							...
							<div class="form-group">
								<label>Nama Alat</label>
									<div class="input-group">
										...
										<input name="namaBarang" type="text" class="form-control" placeholder="Nama Alat"/>
									</div>
							</div>
							<div class="form-group">
								<label>Jumlah</label>
