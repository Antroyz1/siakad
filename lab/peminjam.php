...
<html>
 <head>
    <meta charset="utf-8">
    <title>Peminjam - AKBID Panca Bhakti Pontianak</title>
	<!-- Library CSS -->
	<?php
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              <li class="header"><h4><b><center>ADMIN LAB.</center></b></h4></li>
	              ...
	              <li class="active"><a href="peminjam.php"><i class="fa fa-list-alt"></i><span>Peminjam</span></a></li>
              ...
              <div class="box">
				...
				<!-- <a href="#"><button class="btn btn-success" type="button" data-target="#ModalAdd" data-toggle="modal"><i class="fa fa-plus"></i> Tambah</button></a> -->
				  ...
				  <table id="data" class="table table-bordered table-striped table-scalable">
				  	<a href="#"><button class="btn btn-success" type="button" data-target="#ModalAdd" data-toggle="modal"><i class="fa fa-plus"></i> Tambah</button></a><br />
				  	<a href="cetakLgBook.php" target="_blank"><button class="btn btn-success" type="button" ><i class="fa fa-print"></i> Print Logbook </button></a><br />
		...
		<div id="ModalAdd" class="modal fade" tabindex="-1" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="peminjam_add.php" name="modal_popup" enctype="multipart/form-data" method="post">
							<div class="form-group">
								<label>NIM</label>
									<div class="input-group">
										<div class="input-group-addon">
										...
										<input name="NIM_pinjam" type="text" class="form-control" />
									</div>
							</div>
							<div class="form-group">
								<label>Matakuliah</label>
							...
							<div class="form-group">
								<label>Tanggal Kembali</label>
									<div class="input-group date">
										...
										<input id="Tanggal_Kembali" name="tgl_kembali" type="text" class="form-control" placeholder="Tanggal Pinjam">
									</div>
							</div>
							<div class="modal-footer">
