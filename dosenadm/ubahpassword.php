  ...
  <body class="hold-transition lockscreen">
    <div class="lockscreen-wrapper">
      <div class="lockscreen-logo">
        <p>S I A K A D</p>
		<p><b>STIKES PANCA BHAKTI PONTIANAK</b></p>
      </div>
      <!-- User name -->
      ...
      <div class="lockscreen-item">
        ...
        <form class="lockscreen-credentials" action="user_edit.php" method="post">
      ...
      <div class="lockscreen-footer text-center">
        <strong>Copyright &copy; <?php echo date("Y") ?> - <a href="https://akpb-pontianak.ac.id"> AKBID Panca Bhakti Pontianak</strong>
      </div>
    </div><!-- /.center -->
