	...
	<script type="text/javascript">
		...
		$('#data').on('click', 'a.open_modal', function (e) {
	       e.preventDefault();
	        ...
	        var m = $(this).attr("id");
					$.ajax({
						url: "penelitian_modal_edit.php",
						type: "GET",
						data : {Id_penelitian: m,},
						success: function (ajaxData){
						$("#ModalEditPenelitian").html(ajaxData);
						$("#ModalEditPenelitian").modal('show',{backdrop: 'true'});
						}
					});
	 			} );	
		// Jadwal
		...
		$('#data').on('click', 'a.open_modal', function (e) {
	       e.preventDefault();
	        ...
	        var m = $(this).attr("id");
					$.ajax({
						url: "catatan_modal_edit.php",
						type: "GET",
						data : {Id_catatan: m,},
						success: function (ajaxData){
						$("#ModalEditCatatan").html(ajaxData);
						$("#ModalEditCatatan").modal('show',{backdrop: 'true'});
						}
					});
	 			} );
		});
