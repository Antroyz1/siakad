...
<html>
 <head>
    <meta charset="utf-8">
    <title>DOSEN - STIKES Panca Bhakti Pontianak</title>
	<!-- Library CSS -->
	<?php
							...
							<div class="form-group">
								<label>NIDN</label>
									<div class="input-group">
										...
										<input name="NIP" type="text" class="form-control" placeholder="Nomor Induk Dosen Nasional"/>
									</div>
							</div>
							<div class="form-group">
								<label>Nama Dosen</label>
									<div class="input-group">
										...
										<input name="Nama_Pegawai" type="text" class="form-control" placeholder="Nama Dosen"/>
									</div>
							</div>
							<div class="form-group">
