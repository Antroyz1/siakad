...
<html>
 <head>
    <meta charset="utf-8">
    <title>USER - STIKES Panca Bhakti Pontianak</title>
	<!-- Library CSS -->
	<?php
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              <li class="header"><h4><b><center>ADMINISTRATOR</center></b></h4></li>
              <li><a href="index.php"><i class="fa fa-home"></i><span>Dashboard</span></a></li>
			        ...
			        <li><a href="angkatan.php"><i class="fa fa-graduation-cap"></i><span>Angkatan</span></a></li>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
				<a href="#"><button class="btn btn-success" type="button" data-target="#ModalAddDosen" data-toggle="modal"><i class="fa fa-plus"></i> Tambah Dosen</button></a>
								...
								<label>Usergroup</label>
									<div class="input-group">
										...
										<select name="Id_Usergroup_User" class="form-control">
											<option value=4>Dosen Kebidanan</option>
											<option value=10>Dosen Adminkes</option>
										</select>
									</div>
							</div>
							<div class="form-group">
										...
										<select name="NIP" class="form-control">
											<?php
												...
												while($dosen = mysqli_fetch_array($querydosen)){
													echo "
														<option value='$dosen[NIP]'>$dosen[Nama_Pegawai]</option>";
												}
											?>
										</select>
									</div>
							...
							<div class="form-group">
								<label>Usergroup</label>
									<div class="input-group">
										...
										<select name="Id_Usergroup_User" class="form-control">
											<option value=3 selected>Mahasiswa Kebidanan</option>
											<option value=8 selected>Mahasiswa AdminKes</option>
										</select>
									</div>
							</div>
							<div class="form-group">
								<label>Mahasiswa</label>
									<div class="input-group">
										...
										<select name="User_Mahasiswa" class="form-control">
											<?php
												$querymahasiswa = mysqli_query($konek, "SELECT * FROM mahasiswa ORDER BY NIM DESC");
												if($querymahasiswa == false){
													die ("Terdapat Kesalahan : ". mysqli_error($konek));
												}
												while($mhs = mysqli_fetch_array($querymahasiswa)){
													if($mhs["NIM"] != $_SESSION["Username"]){
														echo "<option value='$mhs[NIM]'>$mhs[Nama_Mahasiswa], Tambah Mahasiswa dengan NIM = $mhs[NIM]</option>";
													}
												}
											?>
										</select>
