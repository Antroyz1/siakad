...
<html>
 <head>
    <meta charset="utf-8">
    <title>JADWAL - STIKES Panca Bhakti Pontianak</title>
	<!-- Library CSS -->
	<?php
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="pegawai.php"><i class="fa fa-user"></i><span>Kepegawaian</span></a></li>
            ...
            <li class="active"><a href="unduh.php"><i class="fa fa-download"></i><span>Unduh</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-download"></i> Unduh</li>
          </ol>
        </section>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="formulir_add.php" name="modal_popup" enctype="multipart/form-data" method="post">
		...
		<div id="ModalEditFormulir" class="modal fade" tabindex="-1" role="dialog"></div>
