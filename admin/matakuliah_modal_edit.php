								...
								<label>Sifat Matakuliah</label>
									<div class="input-group">
										...
										<select name="Sifat" class="form-control">
											<option value="<?php echo $matakuliah["Sifat"]; ?>" selected>
											<?php
												if ($matakuliah["Sifat"]=="Wajib"){
													echo "Wajib";
												}
												else{
													echo "Dasar";
											...
											<?php
												if ($matakuliah["Sifat"]=="Wajib"){
													echo "<option value='Dasar'>Dasar</option>";
												}
												else{
							...
							<div class="form-group">
								<label>Semester</label>
									<div class="input-group">
										...
										<input name="Semester" type="text" class="form-control" value="<?php echo $matakuliah["Semester"]; ?>"/>
									</div>
							</div>
							<div class="form-group">
								<label>SKS</label>
