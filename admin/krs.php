...
<html>
 <head>
    <meta charset="utf-8">
    <title>KELAS - STIKES Panca Bhakti Pontianak</title>
	<!-- Library CSS -->
	<?php
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-sticky-note-o"></i> Kelas</li>
          </ol>
        </section>
							...
							<div class="form-group">
								<label>NIM</label>
									<div class="input-group">
										...
										<input name="NIM_krs_Mhs" type="text" class="form-control" placeholder="Kode Kelas"/>
									</div>
							</div>
									...
									<div class="input-group">
										...
										<select name="Kode_Matakuliah_krs" class="form-control">
											<?php
												...
												$querymatkul = mysqli_query($konek, "SELECT * FROM matakuliah");
							...
							<div class="form-group">
								<label>SKS</label>
									<div class="input-group">
										...
										<input name="SKS_krs" type="text" class="form-control" placeholder="Kode Kelas"/>
									</div>
							</div>
							<div class="form-group">
								<label>Status</label>
		...
		<div id="ModalEditKRS" class="modal fade" tabindex="-1" role="dialog"></div>
