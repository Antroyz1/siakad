...
<html>
 <head>
    <meta charset="utf-8">
    <title>Pegawai - STIKES Panca Bhakti Pontianak</title>
	<!-- Library CSS -->
	<?php
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <ul class="sidebar-menu">
			  ...
			  <li class="active"><a href="pegawai.php"><i class="fa fa-user"></i><span>Kepegawaian</span></a></li>
			  <li><a href="keuangan.php"><i class="fa fa-users"></i><span>keuangan</span></a></li>
