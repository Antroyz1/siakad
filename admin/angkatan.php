...
<html>
 <head>
    <meta charset="utf-8">
    <title>ANGKATAN - STIKES Panca Bhakti Pontianak</title>
	<!-- Library CSS -->
	<?php
    ...
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a href="index.php"><i class="fa fa-home"></i><span>Dashboard</span></a></li>
			        ...
			        <li class="active"><a href="angkatan.php"><i class="fa fa-graduation-cap"></i><span>Angkatan</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-graduation-cap"></i> Angkatan</li>
          </ol>
        </section>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Tambah Angkatan</h4>
					</div>
					<div class="modal-body">
						<form action="angkatan_add.php" name="modal_popup" enctype="multipart/form-data" method="post">
							<div class="form-group">
								<label>Kode Angkatan</label>
									<div class="input-group">
										...
										<input name="Kode_Angkatan" type="text" class="form-control" placeholder="Kode Angkatan"/>
									</div>
							</div>
							<div class="form-group">
								<label>Angkatan</label>
									<div class="input-group">
										...
										<input name="Nama_Angkatan" type="text" class="form-control" placeholder="Angkatan"/>
									</div>
							</div>
