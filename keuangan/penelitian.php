...
<html>
 <head>
    <meta charset="utf-8">
    <title>Penelitian - AKBID Panca Bhakti Pontianak</title>
	<!-- Library CSS -->
	<?php
    ...
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <ul class="sidebar-menu">
			  ...
			  <li class="active"><a href="penelitian.php"><i class="fa fa-sticky-note-o"></i><span>Penelitian</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-user"></i> Riwayat Penelitian</li>
          </ol>
        </section>
