...
<html>
 <head>
    <meta charset="utf-8">
    <title>SPP Siswa - AKBID Panca Bhakti Pontianak</title>
	<!-- Library CSS -->
	<?php
    ...
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <ul class="sidebar-menu">
              <li class="header"><h4><b><center>ADMIN</center></b></h4></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-money"></i> SPP Mahasiswa</li>
          </ol>
        </section>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
				...
				<a href="#"><button class="btn btn-success" type="button" data-target="#ModalCetak" data-toggle="modal"><i class="fa fa-print"></i>   Print </button></a>
                  <br></br>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="spp_add.php" name="modal_popup" enctype="multipart/form-data" method="post">
							<div class="form-group">
								<label>NIM</label>
									<div class="input-group">
										...
										<select name="NIM_Lunas" class="form-control">
											<?php
							...
							<div class="form-group">
								<label>Semester</label>
									<div class="input-group">
										...
										<select name="Semester_Lunas" class="form-control">
							...
							<div class="form-group">
								<label>SPP Semester</label>
									<div class="input-group">
										...
										<input name="SPP_Lunas" type="text" class="form-control" placeholder="SPP Semester"/>
									</div>
							</div>
							<div class="form-group">
								<label>Tanggal</label>
									<div class="input-group date">
										...
										<input id="Tanggal_Lahir" name="Tanggal_Lunas" type="text" class="form-control" />
									</div>
							</div>
							<div class="form-group">
								<label>Status</label>
		...
		<div id="ModalCetak" class="modal fade" tabindex="-1" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="laporan_spp.php" name="modal_popup" enctype="multipart/form-data" method="post">
							<div class="form-group">
								<label>Kelas</label>
									<div class="input-group">
										<div class="input-group-addon">
		...
		<div id="ModalEditSPP" class="modal fade" tabindex="-1" role="dialog"></div>
