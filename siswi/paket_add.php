...
$quetambah = mysqli_query($konek, "SELECT Kode_Matakuliah, Semester_Matakuliah, SKS FROM matakuliah WHERE Kode_Jurusan_Matkul = 'D3BID' AND Semester_Matakuliah ='$Paket'");
if($quetambah == false){
