    ...
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a href="index.php"><i class="fa fa-home"></i><span>Dashboard</span></a></li>
					...
					<li><a href="nilai.php"><i class="fa fa-book"></i><span>Transkip Nilai</span></a></li>
					<li class="active"><a href="pembayaran.php"><i class="fa fa-money"></i><span>Pembayaran</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="far fa-money-bill-alt"></i> Pembayaran</li>
          </ol>
        </section>
