...
<html>
 <head>
    <meta charset="utf-8">
    <title>LIST KRS - STIKES Panca Bhakti Pontianak</title>
	<!-- Library CSS -->
	<?php
    ...
    <div class="wrapper">
          ...
          <div class="user-panel">
            <div class="pull-left image">
	          ...
	          <ul class="sidebar-menu">
			        ...
			        <li class="active"><a href="list_krs.php"><i class="fa fa-archive"></i><span>KRS Semua</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-sticky-note-o"></i> Daftar Kartu Rencana Studi</li>
          </ol>
        </section>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
				<a href="#"><button class="btn btn-info" type="button" data-target="#ModalCetak" data-toggle="modal"><i class="fa fa-print"></i>   Print KRS </button></a>
				<br /><br />
				  <table id="data" class="table table-bordered table-striped table-scalable">
						<?php
							include "dt_krsall.php";
						?>
                  </table>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Print KRS</h4>
          </div>
          <div class="modal-body">
            <form action="cetakKRSall.php" name="modal_popup" enctype="multipart/form-data" method="post">
              <div class="form-group">
                <label>Semester</label>
                  <div class="input-group">
                    ...
                    <?php 
                    $KRS=0;
                    $krsTampil= mysqli_query($konek, "SELECT Semester_Aktif FROM mahasiswa WHERE NIM = '$_SESSION[Username]'"); 
                    if($krsTampil == false){
                            die ("Terjadi Kesalahan : ". mysqli_error($konek));
                          }
                          while ($KT = mysqli_fetch_array ($krsTampil)){
                            $KRS = $KT['Semester_Aktif'];
                          }
										...
										<select name="Kode_Matakuliah_krs" class="form-control">
											<?php
												...
												if ($sms[Semester_Aktif] % 2 ==0){
													$querymatkul = mysqli_query($konek, "SELECT * FROM matakuliah WHERE Kode_Jurusan_Matkul = 'D3BID' AND Semester_Matakuliah % 2 = 0 ORDER BY  Semester_Matakuliah ASC");
												...
												while($matkul = mysqli_fetch_array($querymatkul)){
													echo "
														...
														$querymatkul = mysqli_query($konek, "SELECT * FROM matakuliah WHERE Kode_Jurusan_Matkul = 'D3BID' AND Semester_Matakuliah % 2 = 1 ORDER BY  Semester_Matakuliah ASC");
