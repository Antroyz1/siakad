...
<html>
 <head>
    <meta charset="utf-8">
    <title>KRS - AKBID Panca Bhakti Pontianak</title>
	<!-- Library CSS -->
	<?php
            ...
            <div class="col-xs-12">
              <div class="box">
				...
				<a href="#"><button class="btn btn-success" type="button" data-target="#ModalAdd" data-toggle="modal"><i class="fa fa-plus"></i> Tambah</button></a>
                  ...
                  <a>Harap teliti !! Apabila terjadi kesalahan silahkan hubungi Dosen PA.</a>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!-- /.col -->
          </div><!-- /.row -->
              ...
              <div class="form-group">
                <label>Tanggal Lahir(YYYY-MM-DD)</label>
                  <div class="input-group date">
                    ...
                    <input id="Tanggal_Lahir" name="Tanggal_Lahir" type="text" class="form-control" value="<?php echo $bio["Tanggal_Lahir_Mhs"]; ?>">
                  </div>
              </div>
              <div class="form-group">
