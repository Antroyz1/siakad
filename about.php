      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a href="unduh.php"><i class="fa fa-download"></i><span>Unduh</span></a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					...
					<center><h4><b>Made with <strong><i class="fa fa-code"></i></strong> and <i class="fa fa-heart"></i> by Roymond Chandra Pradana in Pontianak, S.Kom, West Borneo Indonesia</b></h4></center>
                </div><!-- /.box-header -->
                <div class="box-body">
